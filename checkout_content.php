    ...
    <div class="inner">
      ...
      <div id="content"> 
        ...
        <div id="accordion" class="checkout">
          ...
          <h2><a href="#">Delivery Details</a></h2>
          <div>
            <table class="form">
              <tbody>
                <tr>
            ...
            <label for="same-address">
              <input type="checkbox" id="same-address" name="delivery_method"/>
              
              My delivery address is the same as my Payment address</label>
          </div>
          <h2><a href="#">Delivery Method</a></h2>
          <div>
            <p>Please select the preferred shipping method to use on this order.</p>
            <table class="form">
              <tbody>
                <tr>
                  <td style="width: 1px;"><input type="radio" checked="checked" id="flat.flat" value="flat.flat" name="shipping_method"/></td>
                  <td><label for="flat.flat">Flat Rate</label></td>
                  <td style="text-align: right;"><label for="flat.flat">$5.00</label></td>
                </tr>
                <tr>
                  <td style="width: 1px;"><input type="radio" checked="checked" id="dhl" value="flat.flat" name="shipping_method"/></td>
                  <td><label for="dhl">DHL</label></td>
                  <td style="text-align: right;"><label for="flat.flat">$15.00</label></td>
                </tr>
                <tr>
                  <td style="width: 1px;"><input type="radio" checked="checked" id="express" value="flat.flat" name="shipping_method"/></td>
                  <td><label for="express">Express</label></td>
                  <td style="text-align: right;"><label for="flat.flat">$25.00</label></td>
                </tr>
              </tbody>
            </table>
            ...
            <br/>
            <div class="buttons">
              <div class="right"><a class="button" id="button-shipping"><span>Continue</span></a></div>
            </div>
          </div>
