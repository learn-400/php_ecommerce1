      ...
      <div id="content">
        <div class="cart-info">
          <table>
            ...
            <tbody>
              <tr>
                <td class="remove"><input type="checkbox" value="41" name="remove[]"/></td>
                <td class="image"><a href="product.html"><img src="image/left_module_pic.jpg" alt="Spicylicious store" /></a></td>
                <td class="name"><a href="product.html">Extremely long product name goes here</a> <span class="stock">***</span>
                  <div> </div></td>
                <td class="model">Product 14</td>
                <td class="quantity"><input type="text" size="3" value="8" name="quantity[41]"/></td>
                <td class="price">$587.50</td>
                <td class="total">$587.50</td>
              </tr>
              <tr class="odd">
                <td class="remove"><input type="checkbox" value="40" name="remove[]"/></td>
                <td class="image"><a href="product.html"><img src="image/left_module_pic.jpg" alt="Spicylicious store" /></a></td>
                <td class="name"><a href="product.html">Another long product test-name goes here</a>
                  <div> </div></td>
                <td class="model">product 11</td>
                <td class="quantity"><input type="text" size="3" value="1" name="quantity[40]"/></td>
                <td class="price">$118.68</td>
                <td class="total">$118.68</td>
              </tr>
              <tr>
                <td class="remove"><input type="checkbox" value="48" name="remove[]"/></td>
                <td class="image"><a href="product.html"><img src="image/left_module_pic.jpg" alt="Spicylicious store" /></a></td>
                <td class="name"><a href="product.html">Pepper Steak</a> <span class="stock">***</span>
                  <div> </div></td>
                <td class="model">product 20</td>
                <td class="quantity"><input type="text" size="3" value="1" name="quantity[48]"/></td>
                <td class="price">$117.50</td>
        ...
        <div class="cart-module">
          <div class="toggle_holder">
            <div class="cart-heading">Estimate Shipping &amp; Taxes</div>
            <div class="cart-content" style="display: none;">
              ...
              <table id="shipping">
                <tbody>
                  <tr>
                    ...
                    <td><select onchange="$('select[name=\'zone_id\']').load('index.php?route=total/shipping/zone&amp;country_id=' + this.value + '&amp;zone_id=3563');" name="country_id">
                  ...
                  <tr>
                    ...
                    <td><select name="zone_id">
                        ...
                        <option selected="selected" value="3563">Lancashire</option>
              ...
              <a class="button" id="button-quote"><span>Get Quotes</span></a>
              <div style="display: none;" id="quote"></div>
          ...
          <div class="toggle_holder">
            ...
            <div id="coupon" class="cart-content">Enter your coupon here:&nbsp;
              ...
              &nbsp;<a class="button" id="button-coupon"><span>Apply Coupon</span></a></div>
          </div>
          <div class="toggle_holder">
            <div class="cart-heading">Use Gift Voucher</div>
            <div id="voucher" class="cart-content">Enter your gift voucher code here:&nbsp;
              <input type="text" value="" name="voucher"/>
              &nbsp;<a class="button" id="button-voucher"><span>Apply Voucher</span></a></div>
          </div>
        </div>
          ...
          <table>
            <tbody>
              ...
              <tr>
                ...
                <td class="right numbers_total">$823.68</td>
              </tr>
            </tbody>
          </table>
        </div>
